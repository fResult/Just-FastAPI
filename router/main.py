...
@api_router.post("/users/auth", tags=[Tags.authentications, Tags.users])
async def login(
...
@api_router.post("/login/", tags=[Tags.authentications, Tags.users])
...
@api_router.get("users/{user_id}/items/{item_id}", tags=[Tags.users])
...
@api_router.get("/files/{file_path:path}", tags=[Tags.files])
async def get_file(file_path: str):
    return {"file_path": file_path}


@api_router.get("/items/", tags=[Tags.items])
...
@api_router.get("/items/qs", tags=[Tags.items])
...
@api_router.get("/items/{id}", tags=[Tags.items])
async def read_item(
    id: Annotated[
        UUID,
        Path(
...
@api_router.put("/items/{id}", response_model=ItemUpdateResponse, tags=[Tags.items])
...
@api_router.put("/items/{name}/json/", tags=[Tags.items])
...
@api_router.get("/portal", response_model=None)
...
@api_router.post("/files/", tags=[Tags.files])
...
@api_router.post("/upload-file/", tags=[Tags.files])
...
@api_router.get("/elements", tags=[Tags.items], deprecated=True)
...
@api_router.get("/somethings-1/", tags=[Tags.somethings])
...
@api_router.get("/somethings-2/", tags=[Tags.somethings])
...
@api_router.get("/something-3/", tags=[Tags.somethings])
...
@api_router.post("/send-notification/{email}", tags=[Tags.notifications])
...
@api_router.get("/query-checker/", tags=[Tags.query_checkers])
...
@api_router.post("/send-notification-with-dep/{email}", tags=[Tags.notifications])
